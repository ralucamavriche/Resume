  ...
  return (
    <div className="App">
        ...
        <div className="profile-page">
          <nav className="navbar navbar-expand-lg fixed-top bg-primary">
            <div className="container">
              <div className="navbar-translate"><a className="navbar-brand" href="#" >
        ...
        <div>
              ...
              <div className="page-header page-header-small" filter-color="blue">
                ...
                <div className="container">
                  <div className="content-center">
                    ...
                    <p className="category text-white"><br></br></p>
                    <a className="btn btn-black mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor" >Hire Me</a>
                ...
                <div className="section">
                  <div className="container">
                    <div className="button-container">
                      <a className="btn-round " href="#" title="Follow me on Linkedin">
                        <SocialIcon url="https://www.linkedin.com/in/gabriela-raluca-mavriche/" />
                      </a>
                      <a className="btn-round" href="#" title="Follow me on Github">
                        <SocialIcon url="https://github.com/ralucamavriche" />
                      </a>
                      <a className=" btn-round " href="#" title="Follow me on Instagram">
                        <SocialIcon url="https://www.instagram.com/ralucamavriche/" />
                      </a>
                      <a className="btn-round " href="#" title="Follow me on Facebook">
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="card-body">
                      ...
                      <p>Hello! I am Raluca.</p>
                      <p>I am a friendly, responsible and sociable persona. I am open to learning new things,
                      I like to work in a team and I have the ability to learn new technologies quickly.
                       </p>
                    </div>
                  </div>
          ...
          <div className="section" id="project">
            <div className="container text-center">
              <div className="h3 title pb-5 text-center" data-aos="fade-up">Projects</div>
              <div className="row">
                  ...
                  <div className="card mb-3">
                    <div className="card-body py-5" data-aos="zoom-in" data-aos-duration="500">
                      <div className="card-title">
                        ...
                        <p className="font-weight-bold">Blood Donation Management</p>
                      </div>
                      <div className="card-subtitle mb-2 text-muted">
                        MERN Stack, Redux, Bootstrap,SCSS
                      </div>
                      <div style={{ margin: '15px' }} class="btn-project">
                        <a href="https://www.youtube.com/watch?v=KuNZsfiEU_8&feature=youtu.be" class="btn btn-primary">DEMO</a>
                        <a href="https://github.com/ralucamavriche/Blood-Donation-Management" class="btn btn-primary">Github</a>
                      </div>
                      <p className="card-text">
                        The application helps blood donation centers and donors to more easily access certain information, notifies donors when blood is needed, reduces waiting time, and creates a steady flow of
                        donors.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-3 ">
                  <div className="card mb-3">
                    <div className="card-body py-5" data-aos="zoom-in" data-aos-duration="1000">
                      ...
                      <div style={{ margin: '15px' }} class="btn-project">
                        <a href="https://mini-projects-in-react.netlify.app/" class="btn btn-primary">DEMO</a>
                        <a href="https://github.com/ralucamavriche/Mini-Projects-In-React" class="btn btn-primary">Github</a>
                      </div>
                      <p className="card-text" >This application contains several smaller projects  made in React such as: FormValidation or Google Map.</p>
                  ...
                  <div className="card mb-3">
                    <div className="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                      ...
                      <div style={{ margin: '15px' }} class="btn-project">
                        ...
                        <a href="https://github.com/ralucamavriche/Oshop" class="btn btn-primary">Github</a>
                      </div>
                      <p className="card-text">An e-commerce application that has implemented both the admin side and the client side.
                      The application contains: CRUD operations, forms with custom validation, searching, sorting and pagination, authentication and authorization and a lot more!
                       </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-3">
                  <div className="card mb-3">
                    <div className="card-body py-5" data-aos="zoom-in" data-aos-duration="2000">
                      ...
                      <div className="card-subtitle mb-2 text-muted">
                        MongoDB, Node.js, Express.js, React.js, Redux, Reactstrap
                      </div>
                      <div style={{ margin: '15px' }} class="btn-project">
                        <a href="https://ralucamavriche.github.io/MERN-Shopping-List-Client/" class="btn btn-primary">DEMO</a>
                        <a href="https://github.com/ralucamavriche/MERN-Shopping-List-Client" class="btn btn-primary">Github</a>
                      </div>
                      <p className="card-text">The application is created with the MERN Stack. I also implemented Redux for state management and some other things like Reactstrap and React Transitions.
                      On the backend side, I added user registration and login with JWT (JSON Web Tokens) in Node/Express.</p>
                      <div class="btn-project">
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-lg-3 ">
                  <div className="card mb-3">
                    <div className="card-body py-5" data-aos="zoom-in" data-aos-duration="1500">
                      ...
                      <p className="card-text">A client application with a graphical interface that acts as a remote for several competing servers. The customer can choose which devices to
                      connect from those available and he can change the status. I used C / C++ as a technology.</p>
                ...
                <div className="col-lg-3">
                  <div className="card mb-3">
                    <div className="card-body py-5" data-aos="zoom-in" data-aos-duration="2000">
                      ...
                      <div style={{ margin: '15px' }} class="btn-project">
                        <a href="https://github.com/andreeavata2/Wews" class="btn btn-primary">Github</a>
                      </div>
                      <p className="card-text">A web application that centralizes daily articles with a suite of news
                      sites. With a REST API, the user can display all items depending on the
                      selected category. The technologies used are PHP, HTML5&CSS3 and JavaScript.</p>
                ...
                <div className="col-lg-3">
                  <div className="card mb-3">
                    <div className="card-body py-5" data-aos="zoom-in" data-aos-duration="500">
                      ...
                      <div style={{ margin: '15px' }} class="btn-project">
                        <a href="https://github.com/ralucamavriche/ScienceCalc-Android" class="btn btn-primary">Github</a>
                      </div>
                      <p className="card-text">
                        It will have support for trigonometric functions and other functions. Also it will support composed expressions (use math library).
                      </p>
                ...
                <div className="col-lg-3 ">
                  <div className="card mb-3">
                    <div className="card-body py-5" data-aos="zoom-in" data-aos-duration="1000">
                      ...
                      <div style={{ margin: '15px' }} class="btn-project">
                        <a href="https://ralucamavriche.github.io/DesignTest/" class="btn btn-primary">DEMO</a>
                        <a href="https://github.com/ralucamavriche/DesignTest" class="btn btn-primary">Github</a>
                      </div>
                      <p className="card-text" >This application was made during the technical interview. With the help of resources and requirements set by the interviewer,
                      I had to realize the design and functionality of the application.</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="section" id="experience">
            <div className="container cc-experience">
              <div className="h4 text-center mb-4 " style={{ fontWeight: '700' }}>Work Experience</div>
              <div className="card">
                <div className="row">
                  <div className="col-md-3 bg-danger" >
                    <div className="card-body cc-experience-header">
                      <p>10/2017 - 10/2019</p>
                      <div className="h5">Asociația Studenților Informaticieni Ieșeni</div>
                    </div>
                  </div>
                  <div className="col-md-9">
                    <div className="card-body">
                      <div className="h5">Member</div>
                      <p>Involvement in organizing projects within the association: FII Practic, FIICode, Hackathon; but also in those of the
                      faculty: Google HashCode, Stagii pe bune, Admittance, Ziua Porților Deschise had an important role in the
                        development of social and practical skills.</p>
                      <a href="https://asii.ro/" target="_blank">Contact</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-9">
                    <div className="card-body">
                      ...
                      <p>I learned about JavaScript, how to build a REST API, how
                      to secure the API, and how to add authentication to it. I
                      learned to use Express.js as a framework, working with
                      databases (MongoDB) and how to integrate an external
                        service into my API.</p>
                      <a href=" https://fiipractic.asii.ro/" target="_blank">Contact</a>
          ...
          <div className="section">
            <div className="container cc-education">
              <div className="h4 text-center mb-4" style={{ fontWeight: '700' }}> Education</div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-9" >
                    <div className="card-body">
                      ...
                      <p className="category">University of Alexandru Ioan Cuza</p>
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="card-body">
                              ...
                              <p className="pb-2">Bacău, România</p>
      ...
      <footer className="footer">
        <div className="container text-center">
          <a className="cc-linkedin btn btn-link" href="https://www.linkedin.com/in/gabriela-raluca-mavriche/">
            <i aria-hidden="true">
              <FontAwesomeIcon icon={faLinkedin} size="2x" />
            </i>
          </a>
          <a className="cc-github btn btn-link" href="https://github.com/ralucamavriche">
            <i aria-hidden="true">
              <FontAwesomeIcon icon={faGithubAlt} size="2x" />
            </i>
          </a>
          <a className="cc-instagram btn btn-link" href="https://www.instagram.com/ralucamavriche/">
            <i aria-hidden="true">
              <FontAwesomeIcon icon={faInstagram} size="2x" />
            </i>
          </a>
          <a className="cc-facebook btn btn-link" href="https://www.facebook.com/ralucamavriche/">
            <i aria-hidden="true">
